# Program to generate the sounds of notes of a major pentatonic scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a major pentatonic scale
    notes_interval = [2, 2, 3, 2, 3, 3]
    rev_interval = [0, 3, 2, 3, 2, 2]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies of notes in the {notescale} major pentatonic scale in ascending order')
    ...
    print()
    print(f'The frequencies of notes in the {notescale} major pentatonic scale in descending order')
    ...
    # Return list of frequencies in the ascending and descending notes of the major pentatonic scale    
...
# Scale list for which the major pentatonic scale will be played in sequence
scale_list = ['C4', 'E3', 'D4', 'G4', 'Bf3', 'Ds4', 'C4']
